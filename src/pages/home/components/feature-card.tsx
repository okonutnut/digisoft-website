  ...
  return (
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div className="w-full  p-5  mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2 relative py-4">
          {/* TODO */}
          <img src="/images/list-of-products.png" alt="list-of-produtcs" />
        </div>
      </div>

      <div className="absolute bottom-0 z-40 inset-x-0 h-[150px] bg-gradient-to-t from-white dark:from-black via-white dark:via-black to-transparent w-full pointer-events-none" />
